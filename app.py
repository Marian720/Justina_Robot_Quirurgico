...
st.markdown("""
    <style>
        .block-container { padding-top: 45px !important; padding-bottom: 45px !important; }
        ...
        /* --- VALORES DE KPIs --- */
        [data-testid="stMetricLabel"] p { font-size: 18px !important; color: #b0b5c9 !important; }
        ...
        .insight { 
            ...
            margin: 15px 0; font-size: 16px; color: #e8eaf2;
        }
    </style>
...
with tab1:
    ...
    with col_rent:
        ...
        if ingreso_estimado >= meta_facturacion:
            titulo_caja = f"✅ RENTABLE (Cubrimos la meta de {robots_necesarios} robots)"
